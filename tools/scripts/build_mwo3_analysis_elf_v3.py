...
Version 3 fixes an important PS2Recomp interaction:
...
def main():
    ...
    # Critical v3 fix:
    # Neutralize every pre-existing allocatable section whose virtual range
    # intersects the DEMO reservation. They otherwise precede .demo_overlay
    # and can win PS2Recomp's first-match readWord() lookup.
    neutralized = []
